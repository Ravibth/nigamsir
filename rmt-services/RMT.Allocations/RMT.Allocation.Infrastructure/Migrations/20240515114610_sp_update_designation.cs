...
{
    /// <inheritdoc />
    public partial class sp_update_designation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			...
			begin
				...
				SELECT ""e"".""UpdateDate"",""e"".""Designation"",""Id"", ""PipelineCode"", ""JobCode"", ""ProjectCode"", ""JobName"", ""allocation"".""EmpEmail"", ""EmpName"", ""ConfirmedAllocationStartDate"", ""ConfirmedAllocationEndDate"", ""ConfirmedPerDayHours"", ""RequisitionId"", ""AllocationStatus"", ""RecordType"", ""CreatedDate"", ""ModifiedDate"", ""CreatedBy"", ""ModifiedBy"", ""IsActive"", ""PipelineName"", ""ResAllocDetailsId"", ""TotalWorkingDays"", ""ClientName"", ""ResourceAllocationDetailsId"", ""isPerDayHourAllocation"", ""SuspendedAt"", ""isPublish"",""e"".""RatePerHour""
				...
				SELECT  ""allocation"".""UpdateDate"",""allocation"".""Designation"", ""Requisition"".""RequisionId"", ""Requisition"".""PipelineCode"", ""Requisition"".""JobCode"",""Requisition"".""ProjectCode"", 
				""Requisition"".""ProjectName"", ""Requisition"".""RequisitionDescription"", ""Requisition"".""IsContinuousAllocation"", ""Requisition"".""TotalHours"", ""Requisition"".""RequisitionStatus"", ""Requisition"".""Expertise"", 
				...
				select (MAX(""RequisionId"")+1) into NewRequisionId  from ""Requisition"";
					...
					LOOP
					 ...
					 INSERT INTO ""Requisition"" (""RequisionId"",""PipelineCode"", ""JobCode"", ""ProjectCode"", ""ProjectName"", ""RequisitionDescription"", ""IsContinuousAllocation"", ""TotalHours"", ""RequisitionStatus"", ""Expertise"",
					 ...
					 VALUES(rec.""RequisionId"",rec.""PipelineCode"", rec.""JobCode"", rec.""ProjectCode"", rec.""ProjectName"", rec.""RequisitionDescription"", rec.""IsContinuousAllocation"", rec.""TotalHours"", rec.""RequisitionStatus"", rec.""Expertise"",
				  ...
				  FOR allocationRec IN
					...
					(""Id"", ""PipelineCode"", ""JobCode"", ""ProjectCode"", ""JobName"", ""EmpEmail"", ""EmpName"", ""ConfirmedAllocationStartDate"", ""ConfirmedAllocationEndDate"", ""ConfirmedPerDayHours"", ""RequisitionId"", ""AllocationStatus"", ""RecordType"", ""CreatedDate"", ""ModifiedDate"", ""CreatedBy"", ""ModifiedBy"", ""IsActive"", ""PipelineName"", ""ResAllocDetailsId"", ""TotalWorkingDays"",
					 ""ClientName"", ""ResourceAllocationDetailsId"", ""isPerDayHourAllocation"", ""SuspendedAt"", ""isPublish"", ""RatePerHour"")
					 VALUES(ResourceAllocationId, allocationRec.""PipelineCode"", allocationRec.""JobCode"", allocationRec.""ProjectCode"", allocationRec.""JobName"", allocationRec.""EmpEmail"", allocationRec.""EmpName"", allocationRec.""UpdateDate"", allocationRec.""ConfirmedAllocationEndDate"", allocationRec.""ConfirmedPerDayHours"", 
