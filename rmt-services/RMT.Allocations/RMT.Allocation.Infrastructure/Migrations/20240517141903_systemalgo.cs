...
{
    /// <inheritdoc />
    public partial class systemalgo : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sql = @"CREATE OR REPLACE PROCEDURE public.sp_system_suggestions(
...
-- 				 		Checking for smeg, expertise, revenue unit, business unit 
						when lower(parameter_checking) = 'smeg'
							or lower(parameter_checking) = 'expertise'
							or lower(parameter_checking) = 'revenue_unit'
							or lower(parameter_checking) = 'business_unit' 
						then 
...
$$;";
        ...
        {
            migrationBuilder.Sql(@" drop procedure sp_system_suggestions;");
