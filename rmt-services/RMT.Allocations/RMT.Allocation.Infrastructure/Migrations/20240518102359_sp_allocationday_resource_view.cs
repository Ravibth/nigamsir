...
{
    /// <inheritdoc />
    public partial class sp_allocationday_resource_view : Migration
    {
        /// <inheritdoc />
...
AS $BODY$
					...
					on req.""Id"" = res.""RequisitionId""
												...
												res.""AllocationDate"" <= enddate AND details.""AllocationStatus"" IN ('Employee Allocation Accepted By Reviewer', 'Employee Allocation Accepted By Employee','Employee Allocation Reviewer Accepted Resource Requestor Rejected Employee Rejection')
...
$BODY$;";
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            drop procedure sp_allocationday_resource_view;");
        }
    }
}
