...
{
    /// <inheritdoc />
    public partial class sp_allocationday_view_update1607 : Migration
    {
        /// <inheritdoc />
...
begin 
	...
	IF timeoptionname = 'weekly' 
		THEN
			...
			SELECT 
				DATE_TRUNC('week', v.""AllocationDate"") AS monthname,
				SUM(v.""Efforts""),
				v.""Designation"",
	...
	ELSIF timeoptionname = 'monthly' 
		THEN
			INSERT INTO temp_allocation
			SELECT 
				DATE_TRUNC('month', v.""AllocationDate"") AS monthname,
				SUM(v.""Efforts""),
				v.""Designation"",
				SUM(allocation.""RatePerHour"" * v.""Efforts"") AS cost
			FROM public.""allocationdaysreqview"" as v
	...
	ELSIF timeoptionname = 'daily' 
		THEN
			INSERT INTO temp_allocation
			SELECT 
				DATE_TRUNC('day', v.""AllocationDate"") AS monthname,
				SUM(v.""Efforts""),
				v.""Designation"",
				SUM(allocation.""RatePerHour"" * v.""Efforts"") AS cost
			FROM public.""allocationdaysreqview"" as v
