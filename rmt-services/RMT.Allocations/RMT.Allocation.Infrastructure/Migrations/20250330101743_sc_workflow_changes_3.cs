...
{
    /// <inheritdoc />
    public partial class sc_workflow_changes_3 : Migration
    {
        /// <inheritdoc />
						...
						OR(
							LOWER(TRIM(unpub_details.""AllocationStatus"")) in 
								(
									...
									'employee allocation rejected by supercoach'
...
$BODY$;";
        ...
        {
            migrationBuilder.Sql(@"drop procedure sp_availability_system_suggestion");
        }
    }
}
