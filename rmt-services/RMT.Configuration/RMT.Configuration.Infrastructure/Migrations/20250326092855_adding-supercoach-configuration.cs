...
{
    /// <inheritdoc />
    public partial class addingsupercoachconfiguration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69ed0225-64db-445a-bfef-bd739835eb87"), "Employee_Response_Review_process_reviewed_by_Supercoach", "Resource allocation review by Supercoach", "Turning on this toggle at the BU level (or Expertise Level) enables the Resource Allocation Approval Workflow.  Enter the maximum number of days given to the supercoach to approve the allocation. Post this period; the request will be auto-approved. Turning off; will disable the Supercoach workflow feature.", "", true, "Offerings", true, System.Text.Json.JsonDocument.Parse("[{\"Key\":\"Employee_Response_Review_process_reviewed_by_Supercoach\",\"KeyDisplay\":\"Resource allocation review by Supercoach\",\"Description\":\"Resource allocation review by Supercoach\",\"ControlType\":\"Integer\",\"ValidationRegEx\":\"^(-1|[1-4])$\"}]", new System.Text.Json.JsonDocumentOptions()) });
        }
