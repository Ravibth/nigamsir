...
namespace RMT.Employee.Infrastructure.Migrations
{
    ...
    [Migration("20250925120736_expoutsidegt")]
    partial class expoutsidegt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RMT.Employee.Domain.DTOs.EmployeeProjectExperience", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<double>("actual_hours")
                    ...
                    b.Property<string>("client_group")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("skills_utilized")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("EmployeeProjectExperience");
                });
            ...
            modelBuilder.Entity("RMT.Employee.Domain.DTOs.EmployeeProjectExperience", b =>
                {
                    b.HasOne("RMT.Employee.Domain.Entities.EmployeeProfile", null)
                        .WithMany("employee_project_experience")
            ...
            modelBuilder.Entity("RMT.Employee.Domain.Entities.EmployeeProfile", b =>
                {
                    ...
                    b.Navigation("employee_project_experience");
