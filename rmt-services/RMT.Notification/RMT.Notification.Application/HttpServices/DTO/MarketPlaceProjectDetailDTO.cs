...
namespace RMT.Notification.Application.HttpServices.DTO
{
    ...
    public class MarketPlaceProjectDetailDTO
    {
        ...
        public List<EmployeeBasicInfo>? ResourceRequestors { get; set; }//Assuming
        public List<EmployeeBasicInfo>? Reviewer { get; set; }//Assuming
        public List<EmployeeBasicInfo>? Delegate { get; set; }//Assuming
