...
namespace RMT.Notification.Infrastructure.Migrations
{
    ...
    [Migration("20240623201222_Seeder-2306-3")]
    partial class Seeder23063
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RMT.Notification.Domain.Entities.NotificationTemplate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            sub_module = "Notification",
                            subject = "Project: <<ProjectName:ResourceAllocationDetails:item_id>> Allocations Update",
                            template = "You have been assigned to the Project <<ProjectName:ResourceAllocationDetails:item_id>> on <<startdate:ResourceAllocationDetails:item_id>>.",
                            to = "employee_name_allocation_wf",
                            type = "NOTIFICATION_TO_EMPLOYEE_FOR_HIS_ALLOCATION_TASK_TO_PROJECT"
                        },
                        new
