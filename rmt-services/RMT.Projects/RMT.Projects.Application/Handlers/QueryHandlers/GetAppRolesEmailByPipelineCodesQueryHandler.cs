...
{
    public class GetAppRolesEmailByPipelineCodesQuery : IRequest<List<RoleEmailsByPipelineCodeResponse>>
    {
        public List<PipelineCodeAndRolesDto> PipelineCodeAndRolesDto { get; set; }
    }
    public class GetAppRolesEmailByPipelineCodesQueryHandler : IRequestHandler<GetAppRolesEmailByPipelineCodesQuery, List<RoleEmailsByPipelineCodeResponse>>
    {
        private readonly IProjectRepository _projectRepository;
        public GetAppRolesEmailByPipelineCodesQueryHandler(IProjectRepository projectRepository)
        {
            _projectRepository = projectRepository;
        }
        public async Task<List<RoleEmailsByPipelineCodeResponse>> Handle(GetAppRolesEmailByPipelineCodesQuery request, CancellationToken cancellationToken)
        {
            ...
            {
                Dictionary<string, List<ProjectRolesView>> respResult = await _projectRepository.GetProjectRolesByPipelineCodeAndAppRoles(
