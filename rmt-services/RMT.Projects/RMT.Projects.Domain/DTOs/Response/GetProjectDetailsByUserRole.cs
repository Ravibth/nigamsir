...
{
    public class GetProjectDetailsByUserRole
    {
        ...
        public bool? IsBudgetRequired { get; set; }
        ...
        public bool? ProjectClosureState { get; set; }
        public bool? ProjectActivationStatus { get; set; }
        public string? ProjectActivationAndClosureState { get; set; }
