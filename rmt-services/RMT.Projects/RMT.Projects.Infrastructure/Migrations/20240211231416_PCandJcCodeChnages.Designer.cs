...
namespace RMT.Projects.Infrastructure.Migrations
{
    ...
    [Migration("20240211231416_PCandJcCodeChnages")]
    partial class PCandJcCodeChnages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RMT.Projects.Domain.Entities.FieldForMarketPlace", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 2, 11, 23, 14, 16, 120, DateTimeKind.Utc).AddTicks(2036),
                            CreatedBy = "System",
                            DisplayName = "Name of Project",
                            InternalName = "projectName",
                            IsActive = true,
                            ModifiedAt = new DateTime(2024, 2, 11, 23, 14, 16, 120, DateTimeKind.Utc).AddTicks(2041),
                            ModifiedBy = "System"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2024, 2, 11, 23, 14, 16, 120, DateTimeKind.Utc).AddTicks(2043),
                            CreatedBy = "System",
                            DisplayName = "Client Name",
                            InternalName = "clientName",
                            IsActive = true,
                            ModifiedAt = new DateTime(2024, 2, 11, 23, 14, 16, 120, DateTimeKind.Utc).AddTicks(2044),
                            ModifiedBy = "System"
                        },
                        new
                        {
                            Id = 3L,
                            CreatedAt = new DateTime(2024, 2, 11, 23, 14, 16, 120, DateTimeKind.Utc).AddTicks(2046),
                            CreatedBy = "System",
                            DisplayName = "Client Group",
                            InternalName = "clientGroup",
                            IsActive = true,
                            ModifiedAt = new DateTime(2024, 2, 11, 23, 14, 16, 120, DateTimeKind.Utc).AddTicks(2046),
                            ModifiedBy = "System"
                        },
                        new
                        {
                            Id = 4L,
                            CreatedAt = new DateTime(2024, 2, 11, 23, 14, 16, 120, DateTimeKind.Utc).AddTicks(2048),
                            CreatedBy = "System",
                            DisplayName = "Project ID",
                            InternalName = "projectCode",
                            IsActive = true,
                            ModifiedAt = new DateTime(2024, 2, 11, 23, 14, 16, 120, DateTimeKind.Utc).AddTicks(2048),
                            ModifiedBy = "System"
                        });
                });
