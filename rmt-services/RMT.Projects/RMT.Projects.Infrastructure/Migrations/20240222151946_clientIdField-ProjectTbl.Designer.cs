...
namespace RMT.Projects.Infrastructure.Migrations
{
    ...
    [Migration("20240222151946_clientIdField-ProjectTbl")]
    partial class clientIdFieldProjectTbl
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RMT.Projects.Domain.Entities.FieldForMarketPlace", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 2, 22, 15, 19, 45, 866, DateTimeKind.Utc).AddTicks(6930),
                            CreatedBy = "System",
                            DisplayName = "Name of Project",
                            InternalName = "projectName",
                            IsActive = true,
                            ModifiedAt = new DateTime(2024, 2, 22, 15, 19, 45, 866, DateTimeKind.Utc).AddTicks(6934),
                            ModifiedBy = "System"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2024, 2, 22, 15, 19, 45, 866, DateTimeKind.Utc).AddTicks(6938),
                            CreatedBy = "System",
                            DisplayName = "Client Name",
                            InternalName = "clientName",
                            IsActive = true,
                            ModifiedAt = new DateTime(2024, 2, 22, 15, 19, 45, 866, DateTimeKind.Utc).AddTicks(6938),
                            ModifiedBy = "System"
                        },
                        new
                        {
                            Id = 3L,
                            CreatedAt = new DateTime(2024, 2, 22, 15, 19, 45, 866, DateTimeKind.Utc).AddTicks(6940),
                            CreatedBy = "System",
                            DisplayName = "Client Group",
                            InternalName = "clientGroup",
                            IsActive = true,
                            ModifiedAt = new DateTime(2024, 2, 22, 15, 19, 45, 866, DateTimeKind.Utc).AddTicks(6941),
                            ModifiedBy = "System"
                        },
                        new
                        {
                            Id = 4L,
                            CreatedAt = new DateTime(2024, 2, 22, 15, 19, 45, 866, DateTimeKind.Utc).AddTicks(6942),
                            CreatedBy = "System",
                            DisplayName = "Project ID",
                            InternalName = "projectCode",
                            IsActive = true,
                            ModifiedAt = new DateTime(2024, 2, 22, 15, 19, 45, 866, DateTimeKind.Utc).AddTicks(6943),
                            ModifiedBy = "System"
                        });
                });
