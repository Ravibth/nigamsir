...
{
    /// <inheritdoc />
    public partial class employee_working_daysv3 : Migration
    {
        /// <inheritdoc />
             ...
             SELECT ewd.employee_mid,
               ...
               FROM dblink('{ConnStr_WcgtDB}','
                            ...
                            Select ""emp"".""employee_mid"" ""employee_mid"", ""emp"".""employee_code"" ""employee_code"", ""emp"".""name"" ""employee_name"",
	                                    ...
	                                    '::text) ewd(employee_mid text, employee_code text, employee_name text, email_id text, department text, location text, working_date date, week_day_number numeric, designation_name text, grade text, business_unit text, competency text, hourly_rate numeric)
            WITH DATA;
            ";
