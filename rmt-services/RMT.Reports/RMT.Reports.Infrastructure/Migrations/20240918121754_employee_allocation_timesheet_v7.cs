...
{
    /// <inheritdoc />
    public partial class employee_allocation_timesheet_v7 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            CREATE MATERIALIZED VIEW IF NOT EXISTS employee_allocation_timesheet
            ...
            AS
             WITH allocation AS (
                     SELECT allocation.email_id,
                        ...
                        FROM dblink('{ConnStr_AllocationDB}','
                                            ...
                                            on ra.""Id"" = radays.""PublishedResAllocId"" and radays.""AllocationDate""::Date between ra.""StartDate""::date and ra.""EndDate""::date
                                                        ...
                                                        '::text) allocation(email_id text, allocation_date date, allocation_hours numeric, pipeline_code text, job_code text, competency_id text, competency_name text, allocated_cost numeric, chargable text)
                    ), timesheet AS (
