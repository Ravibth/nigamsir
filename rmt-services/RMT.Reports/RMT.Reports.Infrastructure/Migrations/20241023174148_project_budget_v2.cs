...
{
    /// <inheritdoc />
    public partial class project_budget_v2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            string ConnStr_ProjectDB = ConfigConstants.ProjectDbConnStr;
            ...
            AS
             WITH allocation AS (
                     ...
                     Select project_budget.project_code,
                       ...
                       FROM dblink('{ConnStr_ProjectDB}'::text, '
            ...
            migrationBuilder.Sql(
               @$"DROP INDEX IF EXISTS project_budget_index;
                CREATE UNIQUE INDEX project_budget_index ON project_budget (client_name, business_unit, ""location"", pipeline_code, job_code, sme
                , start_date, end_date, expertise, job_name, pipeline_name, csp_user, el_user, total_budget, requisition_count, allocation_count);
                "
               );
        ...
        {
            migrationBuilder.Sql("DROP INDEX IF EXISTS project_budget_index;");
            migrationBuilder.Sql("DROP MATERIALIZED VIEW  IF EXISTS public.project_budget");
        }
    }
}
