...
namespace RMT.Skill.Infrastructure.Migrations
{
    ...
    [Migration("20240205103825_skillcategorydata")]
    partial class skillcategorydata
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RMT.Skill.Domain.Entities.SkillCategoryMaster", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 2, 5, 10, 38, 24, 432, DateTimeKind.Utc).AddTicks(2338),
                            CreatedBy = "System",
                            IsActive = true
                        },
                        new
                        {
                            id = 2L,
                            CategoryName = "Soft",
                            CreateDate = new DateTime(2024, 2, 5, 10, 38, 24, 432, DateTimeKind.Utc).AddTicks(2345),
                            CreatedBy = "System",
                            IsActive = true
                        });
                });
