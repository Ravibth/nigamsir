...
namespace RMT.Skill.Infrastructure.Migrations
{
    ...
    [Migration("20240208080342_skillCode-add")]
    partial class skillCodeadd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RMT.Skill.Domain.Entities.SkillCategoryMaster", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 2, 8, 8, 3, 42, 327, DateTimeKind.Utc).AddTicks(4881),
                            CreatedBy = "System",
                            IsActive = true
                        },
                        new
                        {
                            id = 2L,
                            CategoryName = "Soft",
                            CreateDate = new DateTime(2024, 2, 8, 8, 3, 42, 327, DateTimeKind.Utc).AddTicks(4888),
                            CreatedBy = "System",
                            IsActive = true
                        });
                });
