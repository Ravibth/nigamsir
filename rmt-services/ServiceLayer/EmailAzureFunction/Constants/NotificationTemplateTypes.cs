...
namespace ServiceLayer.Constants
{
    public static class NotificationTemplateTypes
    {
        ...
        public const string CONSOLIDTED_REMINDER = "CONSOLIDTED_REMINDER";

        public const string SUPERCOACH_NOTIFICATION_OF_PENDING_TASK = "SUPERCOACH_NOTIFICATION_OF_PENDING_TASK";

        public const string EMPLOYEE_ABSCONDING_NOTIFCATION = "EMPLOYEE_ABSCONDING_NOTIFCATION";
        public const string EMPLOYEE_LEAVE_NOTIFCATION = "EMPLOYEE_LEAVE_NOTIFCATION";
        public const string ALLOCATION_CONFLICT_NOTIFICATION = "ALLOCATION_CONFLICT_NOTIFICATION";
    }
}
