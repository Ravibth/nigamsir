...
namespace ServiceLayer.Services.WCGT
{
    public class WCGTHttpService : IWCGTHttpService
    {
        ...
        //    var JobListFromWCGT = Convert.ToString(envVarDictionary[Constants.Constants.EnvAppSettingConstants.GET_JOB_LIST_FROM_WCGT]);
        ...
        //        var apiPath = Convert.ToString(environmentVaribles[Constants.Constants.EnvAppSettingConstants.GET_PROJECT_BUDGET_BY_MODIFIED_DATERANGE]);

        //        Dictionary<string, dynamic> queries = new()
        //        {
        //            {"startDate", startDate.ToString(Constants.Constants.BudgetSchedulerDateFormat) },
        //            {"endDate" , endDate.ToString(Constants.Constants.BudgetSchedulerDateFormat) }
        //        };
