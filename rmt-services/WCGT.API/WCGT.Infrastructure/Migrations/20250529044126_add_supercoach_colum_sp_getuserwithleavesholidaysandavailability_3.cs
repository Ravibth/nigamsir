...
{
    /// <inheritdoc />
    public partial class add_supercoach_colum_sp_getuserwithleavesholidaysandavailability_3 : Migration
    {
        /// <inheritdoc />
...
//    );
  ...
  //      FROM ""Employees"" emp
 	//	LEFT JOIN ""Employees"" sup ON emp.employee_mid = sup.supercoach_mid
