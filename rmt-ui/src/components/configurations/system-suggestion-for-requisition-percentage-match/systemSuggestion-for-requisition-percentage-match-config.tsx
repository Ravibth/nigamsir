...
const SystemSuggestionForRequisitionPercentageMatchConfig = (props: any) => {
    ...
    <form onSubmit={handleSubmit(handleSaveClick)}>
      ...
      >
        ...
        <UpdateConfigModal
          ...
          setIsDirty={setIsDirty}
        />
        <Grid container spacing={0} className="system-config-main">
          {businessUnits?.map((item: any, index: number) => {
            return (
              <Grid item key={index}>
                <Grid container alignItems={"center"}>
                  ...
                  >
                    <div className="bu-container mr-15 main-data-container">
                      <TreeItem
                          ...
                          (expertise: any, index: number) => {
                            return (
                              <div className="config-name">
                                <Grid item xs={5} className="config-text-ml">
...
export default SystemSuggestionForRequisitionPercentageMatchConfig;
