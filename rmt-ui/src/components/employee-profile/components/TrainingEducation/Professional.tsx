...
const ProfessionalQualifications: React.FC<ITrainingProps> = ({ tempData, setTempData, onSave,isEditable, ...mainProfileData }) => {

    const { data } = useTrainingEduData(mainProfileData, "Professional");
    ...
    const columnDefs: ColDef<EmployeeQualification>[] = [
        ...
        {
            headerName: 'Month/Year of Passing',
